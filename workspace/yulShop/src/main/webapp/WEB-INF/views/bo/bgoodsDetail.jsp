...
<script src="/resources/js/bo/bgoodsDetail.js"></script>
                ...
                <div class="card-body">
                    ...
                    <form action="/joinusAjax" id='joinform' name='joinform'
                        ...
                        <div class="mb-15 row">
                            ...
                            <div class="col-sm-10">
								<textarea id="info" class="form-control info" maxlength="1000" required>${goods.info }</textarea>
                            </div>
                        </div>
                        <div class="mb-15 row">
                            <label class="col-sm-2 col-form-label ">상품상세</label>
                            <div class="col-sm-10">
								<textarea id="descliption" class="form-control descliption" maxlength="1000" required>${goods.descliption }</textarea>
                            </div>
                        </div>
						<button type="button" id="goodsUploadAjax" class="btn btn-block btn-primary">등록하기</button>
                    </form>   
                    <!-- End Contact Form -->
                </div>
            </div>
