			...
			<div class="row2 row justify-content-center align-items-center"> <!-- 특수마크업 1 -->
				<div class="col-lg-9 text-center mt-5" >
					...
					<div class="narrow-w form-search d-flex align-items-stretch mb-3 text-center">
						...
						style="width:26em;text-transform:lowercase" maxlength="30"
						 placeholder="아이디 8~30자 영문,숫자"  required>
					...
					<div class="narrow-w form-search d-flex align-items-stretch mb-3 text-center">
						<input type="text" name="birth" id="birth" class="form-control px-4"  maxlength="10" placeholder="생년월일 6자리 예) 920110" required>
					</div>
					<div class="narrow-w form-search d-flex align-items-stretch mb-3 text-center">
